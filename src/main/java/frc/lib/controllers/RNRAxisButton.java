...
public class RNRAxisButton extends Button {
	...
	public RNRAxisButton(Joystick joystick, int axis, double threshold, ThresholdType thresholdType) {
		this.joy = joystick;
		this.axis = axis;
	...
	public RNRAxisButton(Joystick joystick, XboxAxis axis, double threshold, ThresholdType thresholdType) {
